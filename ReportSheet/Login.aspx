<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="ReportSheet.Login" %>
...
<html>
<head>
<title>Classpapers: Login Form</title>
   ...
   <!-- Navigation -->
    ...
    <div class="container">	
        <div class="row">
            ...
            <div id="banner">
                <h1>
                    <span class="auto-style1">ClassPaper <strong>LOG IN</strong></span></h1>                
                    <img src="assets2/img/login.jpg" class="img-responsive" />
                        <h1>TO HAVE FULL ACCESS TO OUR RESOURCES</h1>                   
            </div>
        </div>
...
&nbsp;<%-- <asp:login id="UserLogin" runat="server" OnLoggingIn="UserLogin_LoggingIn">
            <LayoutTemplate>--%><fieldset>
                                ...
                                <label for="" style="margin-bottom: 2px"> </label>
                                 <asp:TextBox ID="txtPassword" runat="server" TextMode="Password" Width="319px" Placeholder="Password" ForeColor="White"  cssclass="input-large col-xs-12 qwerty"></asp:TextBox>
                                ...
                                <asp:Button ID="LoginButton" runat="server" CommandName="Login" Text="Login" OnClick="LoginButton_Click" CssClass="button button-block" style="margin-top:20px" BackColor="#339933"  />
               ...
               <%-- </LayoutTemplate>
                        ...
                        <%--<b>Forgot Password?</b>--%>
                        <%--<p>--%>
                          <asp:HyperLink ID="HomeHyperLink" CssClass="badge badge-warning" runat="server" NavigateUrl="index.aspx"><span style="color: white">Home</span></asp:HyperLink> | 
                            ...
                            <asp:HyperLink ID="ForgotPasswordHyperLink" CssClass="badge badge-warning" runat="server" NavigateUrl="~/ForgotPassword.aspx"><span><b>Forgot Password?</b></span></asp:HyperLink>
                                <%--</p>--%>
    ...
    <div id="footer">			
		<p>Copyright &copy; 2018 Myclasspapers. All Rights Reserved</p>
