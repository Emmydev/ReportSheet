<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="preschool.aspx.cs" Inherits="ReportSheet.preschool" %>
           ...
           <div class="row text-center " >           
               <div class="col-lg-12  col-md-12 col-sm-12">
                ...
                <div class="flexslider set-flexi" id="main-section" >                   
                              <%--<h3 style="color:#000000; font-family:'effra'"><strong>Delivering Quality Worksheets</strong></h3>
                           <h1 style="color:#000000; font-family:'effra'">PRESCHOOL CATEGORY</h1>--%>
                    <h3 style="color:#e2e2e2; font-family: monospace; " class="text-center"><strong>Delivering Quality Worksheets</strong></h3>
                     <h2 style="color:#e2e2e2; font-family: monospace; padding-bottom: 150px" class="text-center"><b>Preschool Category</b></h2>
