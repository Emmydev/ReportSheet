<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="ReportSheet.HomePage" %>
        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse move-me">
                <ul class="nav navbar-nav navbar-right" id="submenu">
                    ...
                    <li><asp:LinkButton ID="lknLogOut" OnClick="lknLogOut_Click" runat="server">LOG OUT</asp:LinkButton></li>				 					 
                </ul>
           ...
           <div class="row text-center" > 
               ...
               <div class="col-lg-12  col-md-12 col-sm-12">
                ...
                <div class="flexslider set-flexi" id="main-section" style="text-align: center" >                   
                    ...
                    <h3 style="color:#e2e2e2; font-family: monospace; padding-bottom: 150px" class="text-center"><strong>Delivering Quality Worksheets</strong></h3>
              ...
              <div class="left-blog" style="margin-top: 10px">
                ...
                <%--  <!-- start single post -->
                  <div class="recent-single-post">
                    <div class="post-img">
                      <a href="#">
												   <img src="landingassets/img/blog/1.jpg" alt="" />
												</a>
                    </div>
                  ...
                  <div class="recent-single-post">
                    <div class="post-img">
                      <a href="#">
												   <img src="landingassets/img/blog/2.jpg" alt=""/>
												</a>
                    </div>
                    <div class="pst-content">
                      <p><a href="#"> Redug Lerse dolor sit amet consect adipis elit.</a></p>
                  ...
                  <div class="recent-single-post">
                    <div class="post-img">
                      <a href="#">
												   <img src="landingassets/img/blog/3.jpg" alt=""/>
												</a>
                    </div>
                    <div class="pst-content">
                      <p><a href="#"> Redug Lerse dolor sit amet consect adipis elit.</a></p>
                  ...
                  <div class="recent-single-post">
                    <div class="post-img">
                      <a href="#">
												   <img src="landingassets/img/blog/4.jpg" alt=""/>
												</a>
                    </div>
                    <div class="pst-content">
                      <p><a href="#"> Redug Lerse dolor sit amet consect adipis elit.</a></p>
