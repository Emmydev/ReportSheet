<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="kindergarten.aspx.cs" Inherits="ReportSheet.kindergarten" %>
           ...
           <div class="row text-center " >           
               <div class="col-lg-12  col-md-12 col-sm-12">
                ...
                <div class="flexslider set-flexi" id="main-section" >                   
                     ...
                     <h2 style="color:#e2e2e2; font-family: monospace; padding-bottom: 150px" class="text-center"><b>Kindergarten Category</b></h2>                            
                                <!---- LOG IN----->
